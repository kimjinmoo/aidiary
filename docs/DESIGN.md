...
| 날짜 | 버전 | 내용 |
|---|---|---|
| 2026-07-20 | v3.1 | 반응형/적응형: WindowSizeClass 도입, 태블릿·XR 목록/상세 2-pane, 다이얼로그·필·챗버블 폭 캡, 소형폰 탭라벨·웰컴 weight 버그 수정, resizeableActivity/supports-screens/sw600dp. 작성·상세 감정색(`tagEmotionUi`/`emotionUi`) 토큰 통일 |
